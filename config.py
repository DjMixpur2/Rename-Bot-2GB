...
class Config(object):
    ...
    START_PIC   = os.environ.get("START_PIC", "https://i.postimg.cc/5yjhPCTt/IMG-20250313-214801-808.jpg")
    ...
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1002380095213"))
...
<b>𝘕𝘰𝘵𝘦 :</b>Join Official Channel @CineMoj"""

    ABOUT_TXT = """
<b>❍ ᴍʏ ɴᴀᴍᴇ : <a href='https://telegram.me/CineMoj'>Official Channel</a>
❍ ʜᴏsᴛᴇᴅ ᴏɴ : ᴋᴏʏᴇʙ
❍ ᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
❍ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 𝟹
❍ ᴍʏ ᴄʀᴇᴀᴛᴏʀ : <a href='https://telegram.me/TGSeoboy'>Lakshman</a>
...
<code>By: @CineMoj</code>

💬 For Help Contact @TGSeoboy
"""
