...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("♻ ᴅᴇᴠᴇʟᴏᴘᴇʀ ♻", url='https://telegram.me/Tgseoboy')]
    ])
    if Config.START_PIC:
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview = True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🤖 ᴍᴏʀᴇ ʙᴏᴛs", url="https://telegram.me/CineMoj")],
        ...
        if len(str(user_id)) == 10:
            ...
            try:
                await client.send_message(user_id , f"<b>ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ʙʏ [Lakshman](https://telegram.me/tgseoboy)\nʀᴇᴀsᴏɴ : {reason}</b>")
